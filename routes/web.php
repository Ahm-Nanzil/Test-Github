...
Route::middleware('domain-check')->group(function () {
    ...
    // manually add
    Route::get('package', [HomeController::class, 'Package'])->name('apps.package');
    // Route::get('zenixpack', [HomeController::class, 'index'])->name('apps.zenixpack');
    
    // Route::get('package', function () {
    //     return view('package.workdo');
    // })->name('apps.package');

    Route::get('zenixpack', function () {
        return view('package.zenix');
    })->name('apps.zenixpack');

    Route::get('zenixorginal', [HomeController::class, 'index'])->name('apps.zenixorginal');
