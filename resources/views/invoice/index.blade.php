                                        ...
                                        <td>
                                            ...
                                            <td class="Action">
                                                <span>
                                                    ...
                                                    @endpermission
                                                    @if (module_is_active('ProductService') && ($invoice->invoice_module == 'taskly' ? module_is_active('Taskly') : module_is_active('Account')) && ($invoice->invoice_module == 'cmms' ? module_is_active('CMMS') : module_is_active('Account')))
